<template>
    <div v-if="adminData">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="#" class="flex ms-2 md:me-16">
                            ...
                            <span class="self-center text-sm font-normal text-slate-700 whitespace-nowrap">Admin</span>
                        </a>
                    </div>
                    <div class="flex items-center">
                        <div class="flex items-center ms-3">
                            <button id="dropdownProfileButton" data-dropdown-toggle="profileDropdown"
                                ...
                                type="button">
                                <img :src="`${API_URL}/public/images/profiles/admin/${adminData.photo}`"
                                    class="opacity-85 object-cover w-8 h-8" alt="profile" v-if="!!adminData.photo">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <RouterLink :to="{ name: 'admin.home' }"
                            ...
                            :class="{ 'bg-gray-200': $route.name == 'admin.home' }">
                            <i
        ...
        'bg-gray-200': [
            'admin.categories',
            'admin.categoriesAdd',
            'admin.categoriesEdit',
            'admin.categoriesShow'
        ].includes($route.name as string)
    }">
                            <i
                                class="bi bi-tags-fill text-xl text-gray-500 transition duration-75 group-hover:text-gray-900"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Kategori</span>
                        </RouterLink>
                    </li>
                    <li>
                        <RouterLink :to="{ name: 'admin.admins' }"
                            class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group transition-all"
                            :class="{
        'bg-gray-200': [
            'admin.admins',
            ...
            'admin.adminsShow'
                            ...
                            <i
                                class="bi bi-people-fill text-xl text-gray-500 transition duration-75 group-hover:text-gray-900"></i>
                    ...
                    <li>
                        <RouterLink :to="{ name: 'admin.profile' }"
                            class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group transition-all"
                            :class="{ 'bg-gray-200': ['admin.profile', 'admin.profileEdit'].includes($route.name as string) }">
                            <i
...
export default {
    ...
    methods: {
        ...mapActions(useAdminAuthStore, ['getProfile', 'logout']),
        async performLogout() {
    ...
    computed: {
        ...mapState(useAdminAuthStore, ['adminData', 'adminLoggedIn']),
