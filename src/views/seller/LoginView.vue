<template>
    <div class="flex-1 flex flex-col bg-[url('/images/bg3.jpg')] bg-cover bg-center">
        <div
            ...
            <div class="flex flex-col my-auto">
                <div>
                    <h1 class="text-center text-2xl font-semibold">Login Penjual</h1>
                </div>
                <div class="my-2">
...
export default {
    ...
    methods: {
        ...mapActions(useSellerAuthStore, ['login']),
