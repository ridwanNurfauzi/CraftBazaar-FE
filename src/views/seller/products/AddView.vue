<template>
    <div class="flex-1 flex flex-col flex-wrap" v-if="categories && sellerData">
        <div class="m-4">
            <h1 class="text-center font-medium text-lg">Tambah Produk</h1>
        </div>
        ...
        <div class="m-4" v-if="categories.data">
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name" placeholder="Masukkan nama produk . ." v-model="name"
            ...
            <div class="mb-5" v-if="categories">
                ...
                <div id="categoryDropdown" v-if="categories.data"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCategoryButton">
                        <li v-for="category in categories.data" v-show="!_categories.includes(category)">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" cols="30" rows="7" v-model="description"
            ...
            <div class="mb-5">
                ...
                <input type="number" id="stock" name="stock" min="0" placeholder="Masukkan jumlah stok produk . ."
                    v-model="stock"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                <p class="mt-2 text-sm text-red-600">
                    {{ validation.stock }}
            ...
            <div class="mb-5">
                <label for="price" class="block mb-2 text-sm font-medium text-gray-900">
                    Harga
                    <sup class="text-gray-700">*rupiah</sup>
                </label>
                <input type="text" id="price" name="price" placeholder="Masukkan harga produk . ." v-model="price"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                <p class="mt-2 text-sm text-red-600">
                    {{ validation.price }}
                </p>
            ...
            <div class="mb-5">
                <label for="weight" class="block mb-2 text-sm font-medium text-gray-900">
                    Berat
                    <sup class="text-gray-700">*gram</sup>
                </label>
                <input type="number" id="weight" name="weight" min="1" placeholder="Masukkan berat produk . ."
                    v-model="weight"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                <p class="mt-2 text-sm text-red-600">
                    {{ validation.weight }}
            ...
            <div class="mb-10">
                <button type="button" @click="performAddProduct()"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                    Tambah Produk
                </button>
            </div>
...
export default {
    ...
    methods: {
        ...
        ...mapActions(useSellerProductStore, ['addProducts']),
        ...
        async performAddProduct() {
            ...
            try {
                ...
                const response = await this.addProducts(fData);
