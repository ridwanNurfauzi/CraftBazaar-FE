<template>
    <div class="flex-1 flex flex-col bg-[url('/images/bg2.jpg')] bg-cover bg-center sm:py-12">
        <div
            ...
            <div class="flex flex-col my-auto">
                <div>
                    <h1 class="text-center text-2xl font-semibold">Register Penjual</h1>
                </div>
                <div>
                            ...
                            <div class="flex-1">
                                <div>
                                    ...
                                    <div class="flex flex-col my-5">
                                        ...
                                        <p v-if="!!validation.name" class="mt-2 text-sm text-red-700">
                                            {{ validation.name }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex flex-col my-5">
                                        ...
                                        <p v-if="!!validation.description" class="mt-2 text-sm text-red-700">
...
export default {
    ...
    methods: {
        ...mapActions(useSellerAuthStore, ['register', 'login']),
        addPhoto() {
            ...
            try {
                ...
                if ((!data?.success) && data?.vError) {
                    ...
                    if (loginData?.success) {
                        this.$cookies.set('sellerToken', loginData?.token);
                    ...
                    // this.$cookies.set('sellerToken', data?.token);
                    // this.$router.push({ name: 'seller.home' });
                }
            } catch (error) {
                Swal.fire({
