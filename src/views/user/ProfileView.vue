<template>
    <div class="flex-1 flex flex-col" v-if="!!userData.email">
        <div class="w-full xl:max-w-7xl xl:mx-auto">
            ...
            <div class="md:grid md:grid-cols-3 md:gap-3 mx-4 md:mx-10">
                        ...
                        <div class="w-full h-full bg-opacity-45 bg-white">
                            <div class="w-full h-full bg-cover bg-center">
                                <img v-if="!!userData.photo"
                                    :src="`${API_URL}/public/images/profiles/user/${userData.photo}`"
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mb-5">
                        <button type="button" @click="$router.push({ name: 'user.profileEdit' })"
