<template>
    <div class="flex-1 flex flex-col">
        <div class="w-full xl:max-w-7xl xl:mx-auto">
            <div class="m-4">
                <h1 class="text-center font-medium text-lg">Tambah Admin</h1>
            </div>
            <div class="md:grid md:grid-cols-3 md:gap-3 mx-4 md:mx-10">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mb-5">
                        <button type="button" @click="performAddAdmin()"
...
export default {
    ...
    methods: {
        ...mapActions(useAdminAdminStore, ['addAdmin']),
        changePhoto() {
        ...
        async performAddAdmin() {
            ...
            try {
                ...
                const response = await this.addAdmin(fData);
