<template>
    <div class="flex-1 flex flex-col" v-if="!!adminData">
                    ...
                    <div
                        ...
                        <div class="w-full h-full bg-opacity-45 bg-white">
                            <div class="w-full h-full bg-cover bg-center">
                                <img v-if="!!adminData.photo"
                                    :src="`${API_URL}/public/images/profiles/admin/${adminData.photo}`"
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="name"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            :value="adminData.name" disabled />
                    </div>
                    <div class="mb-5">
                        <button type="button" @click="$router.push({ name: 'admin.profileEdit' })"
